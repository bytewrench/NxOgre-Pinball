...
#define URL_HOST "http://www.yourwebsitegoeshere.com"
...
//==-----------------------------------------------------------------------------
	...
	public:
		webManager();
		static webManager * getWebmanager();
		string getStandings(string version);
		string  postScore(int score, string initials, string version);
		void testInet();
	protected:
	private:
	};
